...
public class OpenCostAssessorOptimizationSchemeWithMRestriction extends DefaultOptimizationScheme {

  public OpenCostAssessorOptimizationSchemeWithMRestriction(IOptimization optimization) {
    super(optimization);
  }
  ...
  public void postCreate() {
    ...
    ICustomNodeLevelRestriction restiction =
        new CustomNodeLetterMRestriction(this.getOptimization().getPropertyProvider());
