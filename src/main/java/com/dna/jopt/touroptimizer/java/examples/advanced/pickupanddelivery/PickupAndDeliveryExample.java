...
public class PickupAndDeliveryExample extends Optimization {
  ...
  public void setProperties() {
    ...
    // ATTENTION: Please use at least 200-500 iterations. The more the better!
    props.setProperty("JOptExitCondition.JOptGenerationCount", "500");

    // ATTENTION: I changed the mode to JOptGenerationCount in principle the other mode is not
    // recommended but also works
    props.setProperty("JOptExitCondition.Type", "JOptGenerationCount");
    props.setProperty("JOptExitCondition.JOptConvergencyCount", "500");

    // ATTENTION: We have to tell the optimizer that we have an high interest in capacity planning
  ...
  public void addRes() {
    ...
    // ATTENTION: We have to specify what is the capacity of the truck
  ...
  public void addNodes() {
    ...
    // ATTENTION: For this working example I added multiple openingHours for all nodes - The
    // optimizer will find the
    //            most suitable openingHour.
    ...
    INode job1 =
        new TimeWindowGeoNode("job1", 50.9333, 6.95, weeklyOpeningHours, visitDuration, 1);
    job1.setLoad(unitsPerTrip);
    this.addElement(job1);

    INode job2 =
        new TimeWindowGeoNode("job2", 51.4667, 6.85, weeklyOpeningHours, visitDuration, 1);
    ...
    INode job4 =
        new TimeWindowGeoNode("job4", 50.8, 6.48333, weeklyOpeningHours, visitDuration, 1);
    ...
    INode job8 =
        new TimeWindowGeoNode("job8", 49.1403, 9.22, weeklyOpeningHours, visitDuration, 1);
